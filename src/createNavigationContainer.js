...
export default function createNavigationContainer(Component) {
  class NavigationContainer extends React.Component {
    ...
    constructor(props) {
      ...
      this.state = {
        nav:
          this._isStateful() && !props.persistenceStorageKey
    ...
    async componentDidMount() {
      ...
      const { persistenceStorageKey } = this.props;
      const startupStateJSON =
        persistenceStorageKey &&
        (await AsyncStorage.getItem(persistenceStorageKey));
    ...
    _persistNavigationState = async nav => {
      ...
      await AsyncStorage.setItem(persistenceStorageKey, JSON.stringify(nav));
    };
